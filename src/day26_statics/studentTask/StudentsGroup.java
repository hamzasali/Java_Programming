...
//        students = new ArrayList<>();
    ...
    } // takes one student obj and add to the arrayList fo students

    public void addStudent(String name, int age, char gender, String id) {
        //Student student = new Student(name, age, gender, id);
        students.add(new Student(name, age, gender, id));
    } // takes name, age, gender, id of student and creates student object by using the given info, then adds the student obj to the arrayList
...
Create a custom class named StudentsGroup
            ...
            Methods:
                ...
                toString(): displays the groupName, groupId and total number of students when a group
